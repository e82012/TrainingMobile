            ...
            <div className="p-3 border-t border-[var(--line)] bg-[var(--card2)]">
              ...
              >
                <input
                  ...
                  placeholder="輸入今日訓練，如：今天 Push A 臥推 50kg 8下四組..."
                  disabled={loading}
                  className="flex-1 bg-[var(--sunken)] border border-[var(--line)] rounded-xl px-3.5 py-2.5 text-xs text-[var(--text)] placeholder-[var(--muted)] focus:outline-none focus:border-[var(--accent)] transition-colors"
                />
                <button
                  type="submit"
